...
namespace GroceryWeb.Controllers
{
    public class PincodeController : Controller
    {
        ...
        {
            var gasNGoContext = _pincodeBLL.GetAll();
        ...
        public IActionResult Create(PincodeDTO pincodeDTO)
        {
            if (ModelState.IsValid)
            {
                _pincodeBLL.Add(pincodeDTO);
                return RedirectToAction(nameof(Index));
            }
            return View(pincodeDTO);
        }
        ...
        public IActionResult Edit(int id)
        {
            ...
            var adminTbl = _pincodeBLL.GetById(id);
            if (adminTbl == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, PincodeDTO pincodeDTO)
        {
            if (id != pincodeDTO.Id)
            {
                return NotFound();
